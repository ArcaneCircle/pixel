...
window.webxdc = (() => {
  ...
  return {
    ...
    sendUpdate: (update, description) => {
      ...
      console.log(
        '[Webxdc] description="' + description + '", ' +
...
window.addXdcPeer = () => {
  ...
  var url = loc.protocol + "//" + loc.host + loc.pathname + "#name=" +
    peerName + "&addr=" + peerName + "@local.host";
  window.open(url);
